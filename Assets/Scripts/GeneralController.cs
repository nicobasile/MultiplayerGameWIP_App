...
namespace ObjectController
{
    ...
    public class GeneralController : MonoBehaviour
    {
        ...
        //public bool canWallJump { get { return collisionState.right || collisionState.left; } }
        ...
        void Awake()
        {
            ...
            // Trigger our properties that have setters with bodies
            skinWidth = _skinWidth;

            // Set our CC2D to ignore all collision layers except what is in our triggerMask
            for( var i = 0; i < 32; i++ )
            {
        ...
        {
            if(onTriggerStayEvent != null) onTriggerStayEvent(col);
        }

        public void OnTriggerExit2D(Collider2D col)
        {
            if(onTriggerExitEvent != null) onTriggerExitEvent(col);
        }
        ...
        // Returns true if horizontal slope was handled, false otherwise.
